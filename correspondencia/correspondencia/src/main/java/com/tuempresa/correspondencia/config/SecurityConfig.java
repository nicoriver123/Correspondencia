...
import com.tuempresa.correspondencia.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .csrf(csrf -> csrf.disable()) // Seguro porque las peticiones reales requieren JWT en header
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/categorias-correspondencia").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/tipos-correspondencia").permitAll()
    ...
    public CorsConfigurationSource corsSource() {
        ...
        // 1. DEBE ser la URL exacta, NUNCA "*"
        config.setAllowedOrigins(List.of("http://localhost:5173"));

        config.setAllowedMethods(List.of("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"));
        config.setAllowedHeaders(List.of("*"));

        // 2. ESTO ES OBLIGATORIO para enviar cookies
